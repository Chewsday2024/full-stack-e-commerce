      ...
      <div className="container mx-auto px-4 py-3">
        <div className='flex flex-wrap justify-between items-center'>
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {isAdmin && (
              <Link to={''} className='bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center'>
